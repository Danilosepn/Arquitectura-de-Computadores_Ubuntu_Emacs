...
*** Preguntas
   ...
   - $[IR] \leftarrow \text{01940}$
   - $[AC] \leftarrow [940]$
   - $[AC] \leftarrow \text{5}$

   - $[PC] \leftarrow [IR]$
   - $[IR] \leftarrow \text{0x300}$
   - $[IR] \leftarrow \text{06941}$
   - $[AC] \leftarrow [AC]-[941]$
   - $[AC] \leftarrow 5-2$
   - $[AC] \leftarrow \text{3}$
   ...
   - $[IR] \leftarrow \text{21940}$
   - $[940] \leftarrow [AC]$
   - $[940] \leftarrow \text{3}$

   - $[PC] \leftarrow [IR]$
   - $[IR] \leftarrow \text{0x301}$
   - $[IR] \leftarrow \text{14000}$
   - $[AC] \leftarrow [AC] * 2$
   - $[AC] \leftarrow \text{6}$
   ...
   - $[IR] \leftarrow \text{21941}$
   - $[941] \leftarrow [AC]$
   - $[941] \leftarrow \text{6}$

   - $[PC] \leftarrow [IR]$
   - $[IR] \leftarrow \text{0x302}$
   - $[IR] \leftarrow \text{02940}$
   - $[AC] \leftarrow -[940]$
   - $[AC] \leftarrow \text{-3}$
