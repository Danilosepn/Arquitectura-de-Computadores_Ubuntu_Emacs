...
#+caption: Certificado de Aprobación - Danilo Unapucha
#+attr_latex: :width 0.75\textwidth :center t
#+label: fig:certificado-integrante 1
[[./images/Danilo_Certificado.jpg]]
...
#+caption: Certificado de Aprobación - Michael Sornoza
#+attr_latex: :width 0.75\textwidth :center t
#+label: fig:certificado-integrante 2
[[./images/Certificado_Michael.png]]

3. *Integrante 3*
   - *Nombre completo:* Matías Palomeque
   - *Correo:* matias.palomeque@epn.edu.ec
   - *Certificado Adjunto*

#+caption: Certificado de Aprobación - Matías Palomeque
#+attr_latex: :width 0.75\textwidth :center t
#+label: fig:certificado-integrante 3
[[./images/CertificadoMatias.png]]


4. *Integrante 4*
   - *Nombre completo:* Sebastian Arevalo
   - *Correo:* martin.arevalo@epn.edu.ec
   - *Certificado Adjunto*

#+caption: Certificado de Aprobación - Sebastian Arevalo
#+attr_latex: :width 0.75\textwidth :center t
#+label: fig:certificado-integrante 4
[[./images/Sebas_certificado.jpg]]
...
- /Alternativa escogida:/ b
- /Justificación técnica:/ Los pines tienen un orden específico, ya
...
- /Alternativa escogida:/ b
-/Justificación técnica:/ Sis e colocan los pines en un orden
...
- /Alternativa escogida:/ b
- /Justificación técnica:/ Los separadores evitan el contacto  entre
...
- /Alternativa escogida:/ b
- /Justificación técnica:/ Al separar la placa madre del gabinete se
...
- /Alternativa escogida:/ b
- /Justificación técnica:/ La pasta térmica ayuda a distrubuir
...
- /Alternativa escogida:/ b
- /Justificación técnica:/ Si el sistema de dispercion de de calor de
...
- /Alternativa escogida: b
- /Justificación técnica:/ Nuestro cuerpo tiende a acumular
...
- /Alternativa escogida: b
- /Justificación técnica:/ El cuerpo humano acumula electricidad
...
- /Alternativa escogida:/ c
- /Justificación técnica:/ El LED del panel frontal en una PC tiene
...
- /Alternativa escogida:/ c
- /Justificación técnica:/ Cuando un led no prende lo mas probable es
...
- /Alternativa escogida:/ b
- /Justificación técnica:/ La ranura PCIe de la placa madre puede
...
- /Alternativa escogida:/ b
- /Justificación técnica:/ LAs tarjetas graficas pueden consumir
...
Estudiante: Matías Palomeque
   ...
   | Insumo                            | Uso principal                                                                          |
   |-----------------------------------+----------------------------------------------------------------------------------------|
   | Pulsera antiestática              | Evita que se acumule electricidad estática en el cuerpo                                |
   | Aire Comprimido                   | Elimina el polvo entre los componentes de manera segura                                |
   | Destornillador con punta Metálica | Se usa para abrir compartimientos cerrados con tornillos, la punta ayuda a sostenerlos |
   | Pasta Térmica                     | Ayuda a distribuir el calor en los componentes de mejor manera                         |
   | Pinzas de Precisión               | Se usan para poder sujetar componentes pequeños                                        |
   | Espuma Limpiadora                 | Se utiliza para poder limpiar la suciedad entre las aspas de los ventiladores          |
   |                                   |                                                                                        |
...
Estudiante: Sebastian Arevalo
   ...
   | Insumo                            | Uso principal                                                                                      |
   |-----------------------------------+----------------------------------------------------------------------------------------------------|
   | Pasta termica                     | Ayuda a distribuir el calor desde el CPU hacia el disipador                                        |
   | Cinta resistente al calor         | Ayuda a sostener siertas partes como el sistema de refrigeracion ya que resiste altas temperaturas |
   | Alcohol isopropilico              | Con este se puede limpiar de manera profunda dispositivos electronicos sin dañar los circuitos     |
   | Aire comprimido                   | Permite limpiar los ventiladores y partes dificiles de alcanzar llenas de polvo                    |
   | Destornillador con punta metalica | Importante para abrir el dispostivo con facilidad y no perder los tornillos en el proseso          |
   | THermal Putty                     | Grasa que ayuda con la disipacion del calor                                                        |
   
** 3.2 Procedimiento de limpieza — Desktop
   1. Apagar completamente la computadora y desconectarla de corriente eléctrica
   2. Desconectar la fuente de poder y retirar los cables necesarios 
   3. Desconectar los ventiladores y demás componentes que eviten el
      facil acceso al interior de la PC
   4. Realizar la limpieza del polvo acumulado en los componentes,
      especialmente de los ventiladores y la placa madre. Para esto es
      recomendable utilizar aire comprimido
   5. Limpiar la superficie de la CPU y GPU con alcohol isopropílico
      para retirar restos de pasta térmica antigua. Luego, aplicar
      nueva pasta térmica y reemplazar los pads térmicos de ser
      necesario.
   6. Utilizar una brocha antiestática para realizar una limpieza final
      antes de reensamblar los componentes
   7. Reconectar todos los componentes y verificar que las conexiones
      estén correctamente instaladas antes de volver a enceder la computadora

** 3.3 Procedimiento de limpieza — Laptop
   1. Apagar correctamente el equipo y desconectarlo de la corriente
   2. Desconectar la batería y cualquier cable que podría dañarse
   4. Limpiar los componentes utilizando aire comprimido. Prestar
      especial atención a lugares que tienen a acumularse de más
      polvo, como los ventiladores, el disipador, la placa madre,
      entre otros.
   5. Limpiar la superficie de la CPU y GPU con alcohol
      isopropílico. Luego, aplicar una nueva capa de pasta térmica.
   6. Utilizar una brocha antiéstatica para realizar una limpieza
      detallada final
   7. Volver colocar a todos los componentes del equipo en su lugar y
...
** Integrante 3 Matías Palomeque
   - *¿Qué conocimiento nuevo obtuvo del curso?* Conocí como están
   ...
   - *¿Qué concepto corrigió o clarificó?* Entendí mejor para que se
   ...
   - *¿Qué conocimiento nuevo obtuvo del curso?* Aprendi sobre las
   ...
   - *¿Qué concepto corrigió o clarificó?* Comprendi mejor como dar
